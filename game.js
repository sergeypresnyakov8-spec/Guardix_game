...
const SUPER_UPGRADES = [
  { id: "code_operators", name: "Закодировать операторов", description: "Операторы начинают работать как будто после ночного релиза без сна, но очень быстро.", cost: 900, tag: "+2 за клик" },
